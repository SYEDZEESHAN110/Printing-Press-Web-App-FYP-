        ...
        <nav id="sidebar" class="sidebar js-sidebar">
            <div class="sidebar-content js-simplebar">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item <?php if ($current_url == ROOT . "/shopadmin/") {
                                                echo "active";
                                            } ?> ">
                    ...
                    <li class="sidebar-item <?php if ($current_url == ROOT . "/shopadmin/new-requests/") {
                                                echo "active";
                                            } ?> ">
                    ...
                    <li class="sidebar-item <?php if ($current_url == ROOT . "/shopadmin/completed-requests/") {
                                                echo "active";
                                            } ?> ">
                    ...
                    <li class="sidebar-item <?php if ($current_url == ROOT . "/shopadmin/payment-methods/") {
                                                echo "active";
                                            } ?> ">
                        <a class="sidebar-link" href="<?php echo ROOT ?>/shopadmin/payment-methods">
                            <i class="align-middle" data-feather="list"></i> <span class="align-middle">Payment
                                Methods</span>
                        </a>
                    </li>
            </div>
