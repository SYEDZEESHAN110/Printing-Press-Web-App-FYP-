            ...
            <table id="default-datatable" class="table table-striped">
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        if ($row['payment_reciept'] && is_string($row['payment_reciept']) && strlen($row['payment_reciept']) >= 4) {
                            echo "<td>";
                            echo "<a class='btn btn-primary' href='" . ROOT . "/{$row['payment_reciept']}' download> Download </a>";
                            echo "</td>";
                        } else {
                            echo "<td>No file</td>";
                        }
